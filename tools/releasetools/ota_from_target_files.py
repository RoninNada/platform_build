...
""" % bcb_dev)
  ...
  script.Print("--------------------------------------------------")
  script.Print("            ____________ _____   ____             ")
  script.Print("           |___  /  ____|  __ \ / __ \            ")
  script.Print("              / /| |__  | |__) | |  | |           ")
  script.Print("             / / |  __| |  _  /| |  | |           ")
  script.Print("            / /__| |____| | \ \| |__| |           ")
  script.Print("           /_____|______|_|  \_\\____/            ")
  script.Print(" ")
  script.Print("                      ZeroROM ")
  script.Print("--------------------------------------------------")
  script.Print(" ")
...
""" % bcb_dev)
  ...
  common.ZipWriteStr(output_zip, "META-INF/org/aosip/releasekey",
